...
"");switch(this._introItems[this._currentStep].position){case "top":a.style.left="15px";a.style.top="-"+(p(a).height+10)+"px";c.className="introjs-arrow bottom";break;case "right":a.style.left=p(b).width+20+"px";c.className="introjs-arrow left";break;case "left":a.style.top=null;a.style.right=p(b).width+20+"px";c.className="introjs-arrow right";break;default:a.style.bottom="-"+(p(a).height+10)+"px",c.className="introjs-arrow top"}}}function w(b){if(b&&this._introItems[this._currentStep]){var a=
p(this._introItems[this._currentStep].element);b.setAttribute("style","width: "+(a.width)+"px; height:"+(a.height)+"px; top:"+(a.top)+"px;left: "+(a.left)+"px;")}}function t(b){var a;"undefined"!==typeof this._introChangeCallback&&this._introChangeCallback.call(this,b.element);var c=this,d=document.querySelector(".introjs-helperLayer");p(b.element);if(null!=d){var f=d.querySelector(".introjs-helperNumberLayer"),A=d.querySelector(".introjs-tooltiptext"),h=d.querySelector(".introjs-arrow"),
...
treeJSON = d3.json(url, function(error, treeData) {
    ...
    var viewerHeight = 745 //$(document).height();
